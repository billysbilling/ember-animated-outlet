// Version: v1.0.0-rc.1-284-g8ba845c
// Last commit: 8ba845c (2013-03-30 18:26:13 -0700)
...
/**
  Copies one or more objects' properties into `original`.

  Only `original` will be altered. `updates` will be left unchanged.

  ```javascript
  Ember.isNone({a: 1}, {b: 2});              // {a: 1, b: 2}
  //You can also supply multiple arguments to merge multiple objects into the first one
  Ember.isNone({a: 1}, {b: 2}, {c: 3});      // {a: 1, b: 2, c: 3}
  ```

  Note that nested properties will be copied as references, i.e. they will not be cloned.
  ...
  Ember.merge(a, b);
  a.child === b.child // true - they are the same object
  ```

  @method merge
  @for Ember
  @param {Object} original The object to copy properties to
